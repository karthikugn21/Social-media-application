...
// MUI Components
import { Box, TextField, Button, Typography, Container, Paper, InputAdornment, keyframes } from "@mui/material";
import { Email, Lock } from "@mui/icons-material";

// Framer Motion for animations
import { motion } from "framer-motion";

// ✅ DEFINE A VIBRANT, DARK-THEME COLOR PALETTE
...
// ✅ CREATE A SUBTLE ANIMATION FOR THE DARK BACKGROUND
            ...
            >
                  ...
                  sx={{
                    '& .MuiOutlinedInput-root': {
                      ...
                      '&.Mui-focused fieldset': {
                        ...
                        boxShadow: `0 0 10px ${accentTransparent}`
                      },
                    },
                  }}
                />
              ...
              <motion.div variants={itemVariants} whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                <Button
                  ...
                  sx={{
                    ...
                    '&:hover': {
                      backgroundColor: '#a5b4fc', // Lighter shade on hover
              ...
              <motion.div variants={itemVariants}>
                <Typography align="center" sx={{color: lightTextColor}}>
                  No account?{" "}
                  <Link to="/signup" style={{ textDecoration: 'none', fontWeight: 'bold', color: primaryAccent }}>
                    Register
                  </Link>
                </Typography>
              </motion.div>
